//+------------------------------------------------------------------+
//| MasterForex-V MultiTF Indicator v8.2                             |
...
//+------------------------------------------------------------------+
bool EnsureHistory(string symbol, ENUM_TIMEFRAMES tf, int attempts=20)
  {
...
int OnInit()
  {
   ...
   IndicatorSetString(INDICATOR_SHORTNAME, "MasterForex-V MultiTF v8.2");
