...
int OnCalculate(const int rates_total,
                ...
                const double &price[])
  {
   ...
   string trendStatus = StringFormat("Trend H1: %s  M15: %s  M5: %s / Тренд H1: %s  M15: %s  M5: %s",
                                     strH1, strM15, strM5, strH1, strM15, strM5);

   // MF-pivot levels lines / Строки уровней MF-pivot
   string levelM5  = "Pivot M5 / Пивот M5: "  + DoubleToString(pivotM5,  _Digits);
   string levelM15 = "Pivot M15 / Пивот M15: " + DoubleToString(pivotM15, _Digits);
   string levelH1  = "Pivot H1 / Пивот H1: "  + DoubleToString(pivotH1,  _Digits);
   string levelH4  = "Pivot H4 / Пивот H4: "  + DoubleToString(mfPivotH4, _Digits);
   string levelD1  = "Pivot D1 / Пивот D1: "  + DoubleToString(mfPivotD1, _Digits);
