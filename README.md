...
- **Информационная панель** с детальной статистикой
 ...
 - [Новый v9] Фоновая дорисовка истории (Backfill) с той же логикой, что и в реальном времени
 - [Новый v9] Исторические стрелки сохраняются (не очищаются на каждом тике)
