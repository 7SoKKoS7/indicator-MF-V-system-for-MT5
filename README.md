...
- `MasterForex_Pivot_my_v83.mq5` — актуальная версия с подтверждёнными pivot, историей сигналов и ранними/выходными метками
...
## 🛠 Чек-лист текущей реализации (v8.3)
...
При отсутствии `ZigZag.ex5` все уровни MF-pivot станут нулевыми и сигналы не появятся. Начиная с версии **8.3**, путь `ZigZagPath` принимает как полный путь к файлу, так и только папку `Examples\\ZigZag`.
...
- Использовать `MasterForex_Pivot_my_v83.mq5` как базу
